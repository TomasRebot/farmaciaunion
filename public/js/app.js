...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/DeleteModalComponent.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/DeleteModalComponent.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    triggerHidden: function triggerHidden() {
      var self = this;
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/DynamicTableComponent.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/DynamicTableComponent.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _DeleteModalComponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DeleteModalComponent */ "./resources/js/components/DeleteModalComponent.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    'delete-modal-component': _DeleteModalComponent__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  mounted: function mounted() {
    this.getResource();
  },
  ...
  computed: {
    canDoSomething: function canDoSomething() {
      var cantidad = 0;
      var obj = this.apiResource.permissions;
      console.log(obj);
      Object.keys(obj).filter(function (item) {
        if (obj[item]) cantidad++;
      });
  ...
  methods: {
    ...
    onExternalUrlClicked: function onExternalUrlClicked() {
      var _this = this;

      if (this.selectedItems.length === 1) {
        var row = this.rows.find(function (row) {
          return row.id === _this.selectedItems[0];
        });
    ...
    onDeleteConfirmation: function onDeleteConfirmation(params) {
      var _this2 = this;

      this.showModal = false;
      var apiParams = {
        model: this.apiResource.resource,
        ids: this.selectedItems
      };
      var url = this.apiResource.deleteUrl;
      axios.post(url, apiParams).then(function (response) {
        if (!response.data.error) {
          toastr.success('se han eliminado los registros seleccionados');
          _this2.rows = _this2.rows.filter(function (row) {
            return !_this2.selectedItems.includes(row.id);
          });
    ...
    onRestoreConfirmation: function onRestoreConfirmation(params) {
      var _this3 = this;
      ...
      var url = this.apiResource.restoreUrl;
      axios.post(url, apiParams).then(function (response) {
        if (!response.data.error) {
          toastr.success('se han restaurado los registros seleccionados');
          _this3.rows = _this3.rows.filter(function (row) {
            return !_this3.selectedItems.includes(row.id);
          });
    ...
    onSelectionChanged: function onSelectionChanged(params) {
      this.selectedItems = params.selectedRows.map(function (item) {
        return item.id;
      });
    },
    onEdit: function onEdit(params) {
      this.selectedItems.length !== 1 ? toastr.error('Debe seleccionar un solo elemento para editar') : window.location.href = this.apiResource.editUrl.replace(this.apiResource.resource, this.selectedItems[0]);
    },
    ...
    onSearchChange: function onSearchChange(params) {
      if (params.searchTerm.length > 2 || params.searchTerm === '') {
        this.updateParams({
          columnFilters: this.apiResource.filters,
    ...
    onColumnFilter: function onColumnFilter() {//TODO IMPLEMENTS THIS METHOD IF IS NEEDED
    },
    ...
    getResource: function getResource() {
      ...
      var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.apiResource.url;
      axios.post(url, this.serverParams).then(function (response) {
        var server = response.data;
        _this4.rows = server.paginator.data;
        _this4.columns = server.columns;
        _this4.totalRecords = server.paginator.total;
        _this4.serverParams.first_page_url = server.paginator.first_page_url;
        _this4.serverParams.from = server.paginator.from;
        _this4.serverParams.last_page = server.paginator.last_page;
        _this4.serverParams.last_page_url = server.paginator.last_page_url;
        _this4.serverParams.next_page_url = server.paginator.next_page_url;
        _this4.serverParams.path = server.paginator.path;
        _this4.serverParams.per_page = server.paginator.per_page;
        _this4.serverParams.prev_page_url = server.paginator.prev_page_url;
        _this4.serverParams.currentPage = server.paginator.current_page;
        console.log(server);
      });
    }
  }
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/DeleteModalComponent.vue?vue&type=template&id=22b5cac6&":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/DeleteModalComponent.vue?vue&type=template&id=22b5cac6& ***!
  \***********************************************************************************************************************************************************************************************************************/
        ...
        _c("div", { staticClass: "modal-content" }, [
          _c("div", { staticClass: "modal-header" }, [
            ...
            _c("h4", { staticClass: "modal-title" }, [
              _vm._v(_vm._s(this.modalQuestion))
            ]),
            _vm._v(" "),
            _vm.isDeleting ? _c("h5", { attrs: { id: "resultado" } }) : _vm._e()
          ]),
          _vm._v(" "),
            ...
            _vm.isRestoring
              ? _c(
                  "button",
                  {
                    ...
                    attrs: { type: "button", "data-action": "restore" },
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/DynamicTableComponent.vue?vue&type=template&id=241f5293&":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/DynamicTableComponent.vue?vue&type=template&id=241f5293& ***!
  \************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    [
                  ...
                  props.column.field == "state"
                    ? _c("span", [
                        props.row.state === "0"
                          ? _c(
                              "span",
                              { staticClass: "bg-danger p-xs b-r-sm" },
                              [_vm._v("Inactivo")]
                            )
                          : _vm._e(),
                        _vm._v(" "),
                        props.row.state === "1"
                          ? _c(
                              "span",
                              { staticClass: "bg-primary p-xs b-r-sm" },
                              [_vm._v("Activo")]
                            )
                          : _vm._e()
                      ])
        ...
        [
                ...
                [
                  _c("div", { staticClass: "btn-group" }, [
                    ...
                    _c(
                      ...
                      [
                        _vm.apiResource.createUrl !== null &&
                        _vm.apiResource.permissions.create
                          ? _c(
                              "button",
                              {
                                staticClass: "btn btn-secondary accion",
                                staticStyle: { "min-width": "300px!important" },
                                attrs: { type: "button" },
                          ...
                          : _vm._e(),
                        _vm._v(" "),
                        _vm.apiResource.deleteUrl !== null &&
                        _vm.apiResource.permissions.delete
                          ? _c(
                              "button",
                              {
                                staticClass: "btn btn-secondary accion",
                              ...
                              [
                                _vm._v(
                                  _vm._s(_vm.apiResource.deleteLabel) +
                                    "\n                    "
                                )
                              ]
                            )
                          : _vm._e(),
                        _vm._v(" "),
                        _vm.apiResource.restoreUrl !== null &&
                        _vm.apiResource.restoreUrl !== undefined &&
                        _vm.apiResource.permissions.update
                          ? _c(
                              "button",
                              {
                                staticClass: "btn btn-secondary accion",
                              ...
                              [
                                _vm._v(
                                  _vm._s(_vm.apiResource.restoreLabel) +
                                    "\n                    "
                                )
                              ]
                            )
                          : _vm._e(),
                        _vm._v(" "),
                        _vm.apiResource.editUrl !== null &&
                        _vm.apiResource.editUrl !== undefined &&
                        _vm.apiResource.permissions.update
                          ? _c(
                              "button",
                              {
                          ...
                          : _vm._e(),
                        _vm._v(" "),
                        _vm.apiResource.externalUrl !== null &&
                        _vm.apiResource.externalUrl !== undefined &&
                        _vm.apiResource.permissions.update
                          ? _c(
                              "button",
                              {
                                ...
                                staticStyle: { "min-width": "300px!important" },
                                attrs: { type: "button" },
                                on: { click: _vm.onExternalUrlClicked }
                              },
                              [
                                _vm._v(
                                  _vm._s(_vm.apiResource.externalLabel) +
                                    "\n                    "
                                )
                              ]
                            )
          ...
          _c(
            ...
            [
              _vm._v(
                "\n            " +
                  _vm._s(_vm.apiResource.emptyTableLabel) +
                  "\n        "
              )
            ]
          )
      ...
      _c("delete-modal-component", {
        attrs: {
          ...
          isRestoring: _vm.isRestoring,
          modalQuestion: _vm.modalQuestion
        },
        on: {
          "on-delete-confirmation": _vm.onDeleteConfirmation,
          "on-restore-confirmation": _vm.onRestoreConfirmation,
          "on-modal-close": _vm.onModalClose
        }
      })
    ],
    1
...
Vue.component('dynamic-table', __webpack_require__(/*! ./components/DynamicTableComponent.vue */ "./resources/js/components/DynamicTableComponent.vue")["default"]);
...
/***/ "./resources/js/components/DeleteModalComponent.vue":
/*!**********************************************************!*\
  !*** ./resources/js/components/DeleteModalComponent.vue ***!
  \**********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _DeleteModalComponent_vue_vue_type_template_id_22b5cac6___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DeleteModalComponent.vue?vue&type=template&id=22b5cac6& */ "./resources/js/components/DeleteModalComponent.vue?vue&type=template&id=22b5cac6&");
/* harmony import */ var _DeleteModalComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DeleteModalComponent.vue?vue&type=script&lang=js& */ "./resources/js/components/DeleteModalComponent.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _DeleteModalComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _DeleteModalComponent_vue_vue_type_template_id_22b5cac6___WEBPACK_IMPORTED_MODULE_0__["render"],
  _DeleteModalComponent_vue_vue_type_template_id_22b5cac6___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/DeleteModalComponent.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/DeleteModalComponent.vue?vue&type=script&lang=js&":
/*!***********************************************************************************!*\
  !*** ./resources/js/components/DeleteModalComponent.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DeleteModalComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./DeleteModalComponent.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/DeleteModalComponent.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DeleteModalComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/DeleteModalComponent.vue?vue&type=template&id=22b5cac6&":
/*!*****************************************************************************************!*\
  !*** ./resources/js/components/DeleteModalComponent.vue?vue&type=template&id=22b5cac6& ***!
  \*****************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_DeleteModalComponent_vue_vue_type_template_id_22b5cac6___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./DeleteModalComponent.vue?vue&type=template&id=22b5cac6& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/DeleteModalComponent.vue?vue&type=template&id=22b5cac6&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_DeleteModalComponent_vue_vue_type_template_id_22b5cac6___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_DeleteModalComponent_vue_vue_type_template_id_22b5cac6___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/components/DynamicTableComponent.vue":
/*!***********************************************************!*\
  !*** ./resources/js/components/DynamicTableComponent.vue ***!
  \***********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _DynamicTableComponent_vue_vue_type_template_id_241f5293___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DynamicTableComponent.vue?vue&type=template&id=241f5293& */ "./resources/js/components/DynamicTableComponent.vue?vue&type=template&id=241f5293&");
/* harmony import */ var _DynamicTableComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DynamicTableComponent.vue?vue&type=script&lang=js& */ "./resources/js/components/DynamicTableComponent.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _DynamicTableComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _DynamicTableComponent_vue_vue_type_template_id_241f5293___WEBPACK_IMPORTED_MODULE_0__["render"],
  _DynamicTableComponent_vue_vue_type_template_id_241f5293___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/DynamicTableComponent.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/DynamicTableComponent.vue?vue&type=script&lang=js&":
/*!************************************************************************************!*\
  !*** ./resources/js/components/DynamicTableComponent.vue?vue&type=script&lang=js& ***!
  \************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DynamicTableComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./DynamicTableComponent.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/DynamicTableComponent.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DynamicTableComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/DynamicTableComponent.vue?vue&type=template&id=241f5293&":
/*!******************************************************************************************!*\
  !*** ./resources/js/components/DynamicTableComponent.vue?vue&type=template&id=241f5293& ***!
  \******************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_DynamicTableComponent_vue_vue_type_template_id_241f5293___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./DynamicTableComponent.vue?vue&type=template&id=241f5293& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/DynamicTableComponent.vue?vue&type=template&id=241f5293&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_DynamicTableComponent_vue_vue_type_template_id_241f5293___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_DynamicTableComponent_vue_vue_type_template_id_241f5293___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
module.exports = __webpack_require__(/*! C:\wamp64\www\farmaciaunion\resources\js\app.js */"./resources/js/app.js");
