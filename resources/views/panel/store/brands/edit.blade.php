                    ...
                    <form action="{{route('brands.update', [$brand])}}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="i-checks"><label> <input type="radio" value="1" name="state" @if(($brand->state)==1) checked="" @endif> <i></i> Activo </label></div>
                            </div>
                            <div class="col-sm-3">
                                <div class="i-checks"><label> <input type="radio" value="0" name="state" @if(($brand->state)==0) checked="" @endif > <i></i> Inactivo </label></div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 col-sm-offset-2">
                                <a href="{{ route('brands.index') }}" class="btn btn-white" type="submit">Cancelar</a>
