        ...
        <div class="tab-content">
            <div id="general" class="tab-pane active">
                <div class="panel-body" style="padding-top:25px">
                    <form action="{{route('laboratories.update', [$laboratory])}}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="i-checks"><label> <input type="radio" value="1" name="state" @if(($laboratory->state)==1) checked="" @endif> <i></i> Activo </label></div>
                            </div>
                            <div class="col-sm-3">
                                <div class="i-checks"><label> <input type="radio" value="0" name="state" @if(($laboratory->state)==0) checked="" @endif > <i></i> Inactivo </label></div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 col-sm-offset-2">
                                <a href="{{ route('laboratories.index') }}" class="btn btn-white" type="submit">Cancelar</a>
