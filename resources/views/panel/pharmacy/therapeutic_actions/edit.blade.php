        ...
        <div class="tab-content">
            <div id="general" class="tab-pane active">
                <div class="panel-body" style="padding-top:25px">
                    <form action="{{route('therapeutic-actions.update', [$therapeuticAction])}}"
                        ...
                        <div class="form-group row @if ($errors->has('description')) has-error @endif">
                            ...
                            <div class="col-sm-8">
                                <input id="input-email" type="text" class="form-control"
                                       value="{{$therapeuticAction->description}}"
                                       name="description">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="i-checks"><label> <input type="radio" value="1" name="state" @if(($therapeuticAction->state)==1) checked="" @endif> <i></i> Activo </label></div>
                            </div>
                            <div class="col-sm-3">
                                <div class="i-checks"><label> <input type="radio" value="0" name="state" @if(($therapeuticAction->state)==0) checked="" @endif > <i></i> Inactivo </label></div>
                            </div>
                        </div>
